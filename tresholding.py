...
picam2 = Picamera2(0)
picam2.preview_configuration.main.size=(720,480) #full screen : 3280 2464
...
while (1):
    ...
    cv2.imshow('Trackbar window', np.zeros((120, 450, 3), np.uint8))
    ...
    cv2.rectangle(mask, (60,430),(580,480),(255,0,0),4)
    cv2.rectangle(mask, (60,370),(580,420),(255,0,0),4)
    cv2.rectangle(mask, (60,310),(580,360),(255,0,0),4)
