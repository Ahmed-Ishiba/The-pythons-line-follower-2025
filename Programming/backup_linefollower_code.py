...
def forward():
    pwm.set_pwm(left_front_1, 0, 500)
    pwm.set_pwm(left_front_2, 0, 0)
	
    pwm.set_pwm(left_back_1, 0, 500)
    pwm.set_pwm(left_back_2, 0, 0)
	
    pwm.set_pwm(right_front_1, 0, 500)
    pwm.set_pwm(right_front_2, 0, 0)
	
    pwm.set_pwm(right_back_1, 0, 500)
...
def right(speed):
    ...
    pwm.set_pwm(left_back_1, 0, 700)
    pwm.set_pwm(left_back_2, 0, 0)
    
    pwm.set_pwm(right_front_2, 0, speed)
    pwm.set_pwm(right_front_1, 0, 0)
	
    pwm.set_pwm(right_back_2, 0, 700)
    pwm.set_pwm(right_back_1, 0, 0)
def left(speed):
    pwm.set_pwm(left_front_2, 0, speed)
    pwm.set_pwm(left_front_1, 0, 0)
	
    pwm.set_pwm(left_back_2, 0, 700)
    pwm.set_pwm(left_back_1, 0, 0)
	
    pwm.set_pwm(right_front_1, 0, speed)
    pwm.set_pwm(right_front_2, 0, 0)
	
    pwm.set_pwm(right_back_1, 0, 700)
    pwm.set_pwm(right_back_2, 0, 0)
def stop():
...
"""
def left(speed):
	pwm.set_pwm(left_front_1, 0, 0)#2 (2000),1(0) ---->left front wheel bakcward
	pwm.set_pwm(left_front_2, 0, 0) #2 (0),1 (0) ---->left front wheel front
	
	pwm.set_pwm(left_back_1, 0, 0) #2 (2000) 1(0) ----> left back wheel backward
	pwm.set_pwm(left_back_2, 0, 0) #2 (0) 1(2000) ----> left back wheel forward

	pwm.set_pwm(right_front_1, 0, 0) #2 (0), 1(2000) ---->right front wheel forward
	pwm.set_pwm(right_front_2, 0, 0) # 2(2000) 1(0) ----> right front wheel backward

	pwm.set_pwm(right_back_1, 0, 0)# 2(0), 1(2000) ---> right backward wheel forawrd
	pwm.set_pwm(right_back_2, 0, 0)# 2(2000) 1(0) ----> right backward wheel backward
"""
"""
hoigher =  (168, 84, 80)
lower =  (0, 0, 26)
...
"""
black_lower = np.array([58, 0, 16], np.uint8)
black_upper =np.array([148, 83, 108], np.uint8)
...
def green(live):
    ...
    h = 0
    area = 0
    green_lower = np.array([50, 45, 81], np.uint8)
    green_upper = np.array([83, 186, 204], np.uint8)
